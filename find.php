...
<link rel="stylesheet" href="css/find.css" text="text.css">
...
<ul id="login_menu">
 ...
 <div id="main">
    <form method="post" action="member_find_id.php">
       ...
       <div class="idfind"> <h2>아이디 찾기
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;비밀번호 찾기</h2>
       </div class="idfind">
      ...
      <div class="idfind2">
         <table width="1400">
              <tr>
                <td>&nbsp;이름</td>
                <td><input type="text1" size="20" name="name" placeholder="이름을 입력해주세요."></td>
              </tr>
              <tr>
                <td><br>이메일</td>
                <td><input type="text2" name="email" placeholder="이메일을 입력해주세요." >&nbsp@<select name="emadress" size="0">
					<option value="choice">이메일선택</option>
		...
		<form method="post" action="member_find_pw.php">
			<div class="idfind3">
              ...
              <tr>
			  	<td>아이디</td>
                <td><input type="text3" size="20" name="id" placeholder="아이디를 입력해주세요"></td>
              </tr>
			</div>
